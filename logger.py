...
FIELD_NOTES = {
    ...
    "tire_temp_fl": "Tire temp degF (front-left)",
    "tire_temp_fr": "Tire temp degF (front-right)",
    "tire_temp_rl": "Tire temp degF (rear-left)",
    "tire_temp_rr": "Tire temp degF (rear-right)",
